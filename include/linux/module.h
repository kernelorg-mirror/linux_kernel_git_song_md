...
#define mod_core_rodata mod_mem[MOD_MEM_TYPE_RODATA]
#define mod_core_ro_after_init mod_mem[MOD_MEM_TYPE_RO_AFTER_INIT]
#define mod_init_text mod_mem[MOD_MEM_TYPE_INIT_TEXT]
#define mod_init_data mod_mem[MOD_MEM_TYPE_INIT_DATA]
#define mod_init_rodata mod_mem[MOD_MEM_TYPE_INIT_RODATA]
